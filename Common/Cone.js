...
function Cone( gl, numSides, vertexShaderId, fragmentShaderId ) {
    ...
    this.render = function () {
        ...
        //
        gl.drawElements( gl.TRIANGLE_STRIPS, this.indices.count, gl.UNSIGNED_SHORT, 0 );

        // Draw the cone's top
        //
        var offset = this.indices.count * 2 /* sizeof(UNSIGNED_INT) */;
        gl.drawElements( gl.TRIANGLE_STRIPS, this.indices.count, gl.UNSIGNED_SHORT, offset );
    }
};
